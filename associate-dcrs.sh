...
create_dcr_association "healthagent_raw_dcr" "$VM_ID" "healthagent-${SCHEDULER_VM_NAME}-association" "AzSlurm health agent logs"
...
echo "  healthagent_raw_dcr - AzSlurm health agent logs"
